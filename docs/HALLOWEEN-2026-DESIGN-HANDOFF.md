...
4. Halloween is **scheduled October 1 to November 1, 2026**, unchanged. Use `?rizo_event=on` before October 1, or the existing Always on setting when appropriate. This is a Halloween date countdown, not an unconfirmed merchandise-drop timer.
